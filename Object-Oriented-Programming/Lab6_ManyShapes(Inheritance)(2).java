...
class ManyShapes{
	...
	public void listAllShapes() {
		for(int i = 0; i < allShapes.size(); i++) {
			if(allShapes.get(i) instanceof Shape) {
			//if(allShapes.get(i).getClass().equals(Shape.class)) {
				System.out.println(allShapes.get(i).getClass().getName() + " has area " + ((Shape)allShapes.get(i)).area());
				}
			else if(allShapes.get(i) instanceof Circle) {
			//else if(allShapes.get(i).getClass().equals(Circle.class)) {
				System.out.println(allShapes.get(i).getClass().getName() + " has area " + ((Circle)allShapes.get(i)).area());
				}
			else if(allShapes.get(i) instanceof Dot) {
			//else if(allShapes.get(i).getClass().equals(Dot.class)) {
				System.out.println(allShapes.get(i).getClass().getName() + " has area " + ((Dot)allShapes.get(i)).area());
				}
			else if(allShapes.get(i) instanceof Rectangle) {
			//else if(allShapes.get(i).getClass().equals(Rectangle.class)) {
				System.out.println(allShapes.get(i).getClass().getName() + " has area " + ((Rectangle)allShapes.get(i)).area());
				}
			else if(allShapes.get(i) instanceof Square) {
			//else if(allShapes.get(i).getClass().equals(Square.class)) {
				System.out.println(allShapes.get(i).getClass().getName() + " has area " + ((Square)allShapes.get(i)).area());
				}
			else 
				break;
		}
